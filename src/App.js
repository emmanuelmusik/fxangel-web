...
function NewsRow({ item }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ flexShrink: 0, width: 70, fontSize: 9, lineHeight: 1.4 }}>
        {item.date && (
          <div style={{ color: "#58a6ff", fontFamily: "'Space Mono', monospace", marginBottom: 1 }}>{item.date}</div>
        )}
        <div style={{ color: "#8b949e", fontFamily: "'Space Mono', monospace" }}>{item.time}</div>
      </div>
      <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
          ...
          <div style={{ textAlign: "right", display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4 }}>
            ...
            <div style={{ color: "#8b949e", fontSize: 9, fontFamily: "'Space Mono', monospace" }}>
              {getLocalTimeString()}
            </div>
            <a
              href="https://arbangel-frontend.vercel.app/"
              target="_top"
              style={{
                textDecoration: "none",
                background: "#ffa50215",
